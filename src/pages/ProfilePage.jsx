        ...
        const ProfilePage = ({ showToast }) => {
            ...
            return (
                <div>
                    ...
                    <button className="full-width-button" onClick={() => navigate('/settings')} style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', backgroundColor: '#f1f5f9', color: '#334155', border: '1px solid #cbd5e1' }}>
